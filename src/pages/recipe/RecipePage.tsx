...
const RecipePage = ({ recipe = mockRecipe }: { recipe?: Recipe }) => {
  let [isLiked,toggleLike]=useState(recipe.isLikedByMe);
  return (
      <S.RecipePageContainer>
        <S.RecipeImageContainer>
          ...
          <S.HeartButton onClick={() => {toggleLike(!isLiked) ;console.log(isLiked)}}>
          <FontAwesomeIcon  size='xl' color="#F984B5" icon={isLiked? rHeart: faHeart}></FontAwesomeIcon>
          </S.HeartButton>
        </S.RecipeImageContainer>
        <div>
          ...
          <S.RecipeInfo>
            ...
            <S.RecipeInfoItem><FontAwesomeIcon color="#F984B5" icon={faHeart}></FontAwesomeIcon> {recipe.likes} </S.RecipeInfoItem>
