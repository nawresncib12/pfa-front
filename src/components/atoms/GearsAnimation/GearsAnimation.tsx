    ...
    <S.GearsAnimationContainer>
      <S.BiggerGearsAnimationContainer>
        ...
        >
          <S.Gear
            icon={faGear}
            style={{ color: gearColors[0] || generateRandomPastel(theme) }}
          />
        </S.GearWrapper>
        <S.GearWrapper
          animate={{ rotate: -360 }}
        ...
        >
          <S.Gear
            icon={faGear}
            style={{ color: gearColors[1] || generateRandomPastel(theme) }}
          />
        </S.GearWrapper>
        <S.GearWrapper
          animate={{ rotate: 360 }}
        ...
        >
          <S.Gear
            icon={faGear}
            style={{ color: gearColors[2] || generateRandomPastel(theme) }}
          />
        </S.GearWrapper>
      </S.BiggerGearsAnimationContainer>
    </S.GearsAnimationContainer>
